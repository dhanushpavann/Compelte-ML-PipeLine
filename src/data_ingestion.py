...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error("Unexcepted error during preprocessing of data: %s",e)
        raise
...
def main():
    try:
        ...
        data_path="https://raw.githubusercontent.com/dhanushpavann/Datasets/refs/heads/main/spam.csv"
